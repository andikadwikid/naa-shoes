...
async function seedBlogData() {
  ...
  const authors = await Promise.all([
    prisma.author.upsert({
      where: { email: 'sarah@naashoes.com' },
      update: {},
      create: {
        name: 'Sarah Fashion',
        email: 'sarah@naashoes.com',
        avatar: 'https://images.unsplash.com/photo-1494790108755-2616b612b1c5?w=100&h=100&fit=crop&crop=face',
        bio: 'Fashion expert with 10+ years of experience in women\'s footwear trends.'
      }
    }),
    prisma.author.upsert({
      where: { email: 'maya@naashoes.com' },
      update: {},
      create: {
        name: 'Maya Care Expert',
        email: 'maya@naashoes.com',
        avatar: 'https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?w=100&h=100&fit=crop&crop=face',
        bio: 'Shoe care specialist and maintenance expert.'
      }
    }),
    prisma.author.upsert({
      where: { email: 'fitri@naashoes.com' },
      update: {},
      create: {
        name: 'Dr. Fitri Podiatrist',
        email: 'fitri@naashoes.com',
        avatar: 'https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=100&h=100&fit=crop&crop=face',
        bio: 'Podiatrist specializing in foot health and proper footwear fitting.'
      }
    }),
    prisma.author.upsert({
      where: { email: 'aisha@naashoes.com' },
      update: {},
      create: {
        name: 'Aisha Style Consultant',
        email: 'aisha@naashoes.com',
        avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop&crop=face',
        bio: 'Personal stylist and fashion consultant.'
      }
    }),
    prisma.author.upsert({
      where: { email: 'rini@naashoes.com' },
      update: {},
      create: {
        name: 'Rini Fashion Analyst',
        email: 'rini@naashoes.com',
        avatar: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=100&h=100&fit=crop&crop=face',
        bio: 'Fashion industry analyst and brand specialist.'
      }
    }),
    prisma.author.upsert({
      where: { email: 'eco@naashoes.com' },
      update: {},
      create: {
        name: 'Green Fashion Advocate',
        email: 'eco@naashoes.com',
        avatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&h=100&fit=crop&crop=face',
        bio: 'Sustainable fashion advocate and environmental consultant.'
      }
    })
  ])
  ...
  const categories = await Promise.all([
    prisma.blogCategory.upsert({
      ...
      create: {
        name: 'Fashion Trends',
        slug: 'fashion-trends',
        description: 'Latest trends in women\'s footwear and fashion'
      }
    }),
    prisma.blogCategory.upsert({
      where: { slug: 'care-tips' },
      update: {},
      create: {
        name: 'Care Tips',
        slug: 'care-tips',
        description: 'Tips and tricks for maintaining your shoes'
      }
    }),
    prisma.blogCategory.upsert({
      where: { slug: 'health-fit' },
      update: {},
      create: {
        name: 'Health & Fit',
        slug: 'health-fit',
        description: 'Health and fitting guidance for proper footwear'
      }
    }),
    prisma.blogCategory.upsert({
      where: { slug: 'styling-tips' },
      update: {},
      create: {
        name: 'Styling Tips',
        slug: 'styling-tips',
        description: 'Style guides and outfit coordination tips'
      }
    }),
    prisma.blogCategory.upsert({
      ...
      create: {
        name: 'Shopping Guide',
        slug: 'shopping-guide',
        description: 'Smart shopping tips and brand comparisons'
      }
    }),
    prisma.blogCategory.upsert({
  ...
  const blogPosts = [
    {
      ...
      authorEmail: 'sarah@naashoes.com',
    ...
    },
    {
      ...
      authorEmail: 'maya@naashoes.com',
      categorySlug: 'care-tips',
      readTime: 7,
      isPublished: true,
      isFeatured: false,
    ...
    },
    {
      ...
      authorEmail: 'fitri@naashoes.com',
      categorySlug: 'health-fit',
      readTime: 6,
      isPublished: true,
      isFeatured: false,
    ...
    },
    {
      ...
      authorEmail: 'aisha@naashoes.com',
    ...
    },
    {
      ...
      authorEmail: 'rini@naashoes.com',
      categorySlug: 'shopping-guide',
      readTime: 6,
      isPublished: true,
      isFeatured: false,
  ...
  for (const postData of blogPosts) {
    const author = authors.find(a => a.email === postData.authorEmail)
