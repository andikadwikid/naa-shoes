...
async function main() {
  ...
  const products = [
    ...
    },
    {
      ...
      colors: ["Black", "Brown"],
      image:
        "https://images.unsplash.com/photo-1608256246200-53e8b47b90fb?w=400&h=400&fit=crop",
    },
    {
      ...
      colors: ["Pink", "White"],
      image:
        "https://images.unsplash.com/photo-1594618378082-0e69b9c0bf27?w=400&h=400&fit=crop",
    },
    {
      ...
      colors: ["White", "Silver"],
      image:
        "https://images.unsplash.com/photo-1596702673151-1a7cec24e7b7?w=400&h=400&fit=crop",
    },
    {
    ...
    },
    {
      ...
      colors: ["Nude", "Brown"],
      image:
        "https://images.unsplash.com/photo-1502391709512-fde5963d88a5?w=400&h=400&fit=crop",
    },
    {
    ...
    },
    {
      ...
      colors: ["Silver", "Gold"],
      image:
        "https://images.unsplash.com/photo-1564969993608-b8b0e5b0e0e6?w=400&h=400&fit=crop",
    },
    {
    ...
    },
    {
      ...
      colors: ["White", "Silver"],
      image:
        "https://images.unsplash.com/photo-1588484628369-dd7a85bfdc38?w=400&h=400&fit=crop",
    },
    {
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1506629905851-d6633b4417b1?w=400&h=400&fit=crop",
    },
    {
    ...
    },
    {
      ...
      colors: ["Black", "Brown"],
      image:
        "https://images.unsplash.com/photo-1542840410-3092f99611a3?w=400&h=400&fit=crop",
    },
    {
    ...
    },
    {
      ...
      colors: ["Pink", "White"],
      image:
        "https://images.unsplash.com/photo-1593187315802-4a09e6618dd0?w=400&h=400&fit=crop",
    },
  ];
  ...
  for (const productData of products) {
    ...
    const productColors = productData.colors.map(
      (colorName) => colors.find((c) => c.name === colorName)!.id
    );
    ...
    const generateGalleryImages = (baseImage: string, productName: string) => {
      const galleryVariations = [
        {
          url: baseImage,
          caption: `Main view of ${productName}`,
          displayOrder: 0,
        },
        {
          url: baseImage.replace("crop", "crop&bg=f8f9fa"),
          caption: `Alternative view of ${productName}`,
          displayOrder: 1,
        },
        {
          url: baseImage.replace("crop", "crop&bg=gray"),
          caption: `Side view of ${productName}`,
          displayOrder: 2,
        },
      ];
    ...
    const galleryImagesData = generateGalleryImages(
      productData.image,
      productData.name
    );
    ...
    await prisma.product.create({
      data: {
        ...
        sizes: {
          create: [
            {
              sizeId: sizes.find((s) => s.value === 36)!.id,
              stock: Math.floor(Math.random() * 10) + 1,
            },
            {
              sizeId: sizes.find((s) => s.value === 37)!.id,
              stock: Math.floor(Math.random() * 10) + 1,
            },
            {
              sizeId: sizes.find((s) => s.value === 38)!.id,
              stock: Math.floor(Math.random() * 10) + 1,
            },
            {
              sizeId: sizes.find((s) => s.value === 39)!.id,
              stock: Math.floor(Math.random() * 10) + 1,
            },
            {
              sizeId: sizes.find((s) => s.value === 40)!.id,
              stock: Math.floor(Math.random() * 10) + 1,
            },
          ],
        },
