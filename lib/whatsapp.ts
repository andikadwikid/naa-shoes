...
export const generateWhatsAppLink = (
  ...
  const message = generateWhatsAppMessage(cartItems, totalItems, totalPrice, config)
...
export const getWhatsAppConfig = (): WhatsAppConfig => {
  ...
  return {
    ...
    number: process.env.NEXT_PUBLIC_WHATSAPP_NUMBER || defaultWhatsAppConfig.number,
    storeName: process.env.NEXT_PUBLIC_STORE_NAME || defaultWhatsAppConfig.storeName,
  }
}
