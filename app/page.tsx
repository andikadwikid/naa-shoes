  ...
  return (
    <>
      ...
      <div className="min-h-screen">
        {/* Hero Banner */}
        <section className="relative bg-gradient-to-r from-pink-500 to-rose-400 text-white overflow-hidden" role="banner">
          ...
          <div className="relative max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-16 sm:py-20 md:py-32">
            <header className="text-center">
              ...
              <nav className="flex flex-col sm:flex-row gap-4 sm:gap-4 justify-center items-center" aria-label="Call to action buttons">
                <Link
                  href="/products"
                  className="bg-white text-pink-600 font-semibold px-6 sm:px-8 py-3 sm:py-4 rounded-lg hover:bg-pink-50 active:bg-pink-100 transition-all duration-200 transform hover:scale-105 text-base sm:text-lg touch-manipulation"
                  aria-label="Lihat koleksi produk sepatu wanita"
                >
                  Shop Now
                </Link>
                <Link
                  href="/about"
                  className="border-2 border-white text-white font-semibold px-6 sm:px-8 py-3 sm:py-4 rounded-lg hover:bg-white hover:text-pink-600 active:bg-pink-50 transition-all duration-200 text-base sm:text-lg touch-manipulation"
                  aria-label="Pelajari lebih lanjut tentang NAA Shoes"
                >
                  Learn More
                </Link>
              </nav>
        ...
        <section className="py-12 sm:py-16 lg:py-20 bg-white" aria-labelledby="featured-products-heading">
          <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
            ...
            <footer className="text-center mt-8 sm:mt-12">
              <Link
                ...
                aria-label="Lihat semua produk sepatu wanita"
              >
                View All Products
        ...
        {/* Categories Section */}
        <section className="py-12 sm:py-16 lg:py-20 bg-gray-50" aria-labelledby="categories-heading">
          <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
            <header className="text-center mb-8 sm:mb-12">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 sm:gap-6 lg:gap-8" role="list">
              {[
                ...
                <Link
                  ...
                  role="listitem"
                  aria-label={`Lihat kategori ${category.name} - ${category.count}`}
                >
                  <div className="relative aspect-square">
                    <Image
                      src={category.image}
                      alt={`Koleksi ${category.name} NAA Shoes`}
                      fill
        ...
        <section className="py-12 sm:py-16 lg:py-20 bg-gray-50" aria-labelledby="blog-heading">
          <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
            <header className="text-center mb-8 sm:mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-8 sm:mb-12" role="list">
              {[
                ...
                <article key={index} className="bg-white rounded-xl shadow-sm overflow-hidden hover:shadow-lg transition-shadow duration-300" role="listitem">
                  <Link href={`/blog/${post.slug}`} className="block" aria-label={`Baca artikel: ${post.title}`}>
                    <div className="relative h-48">
                      <Image
                        src={post.image}
                        alt={`Gambar artikel: ${post.title}`}
                        fill
            ...
            <footer className="text-center">
              <Link
                href="/blog"
                className="inline-flex items-center bg-pink-600 hover:bg-pink-700 text-white font-semibold px-6 py-3 rounded-lg transition-colors duration-200"
                aria-label="Lihat semua artikel blog fashion"
              >
                Lihat Semua Artikel
                <svg className="ml-2 w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
        ...
        {/* Newsletter Section */}
        <section className="py-12 sm:py-16 lg:py-20 bg-pink-600 text-white" aria-labelledby="newsletter-heading">
          <div className="max-w-4xl mx-auto px-3 sm:px-6 lg:px-8 text-center">
            ...
            <form className="max-w-md mx-auto flex flex-col sm:flex-row gap-3 sm:gap-4" aria-label="Newsletter subscription">
              ...
              <button 
                type="submit"
                className="bg-white text-pink-600 font-semibold px-6 py-3 rounded-lg hover:bg-pink-50 active:bg-pink-100 transition-colors duration-200 whitespace-nowrap touch-manipulation"
