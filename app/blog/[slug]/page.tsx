          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            <article className="lg:col-span-3" itemScope itemType="https://schema.org/BlogPosting">
              ...
              <header className="mb-8">
                <div className="mb-4">
                  <span className="inline-block bg-pink-100 text-pink-600 px-3 py-1 rounded-full text-sm font-medium uppercase tracking-wide" itemProp="articleSection">
                    {post.category}
                  </span>
                </div>
                
                <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-6 leading-tight" itemProp="headline">
                  {post.title}
                </h1>
                
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
                  <div className="flex items-center space-x-4" itemScope itemType="https://schema.org/Person" itemProp="author">
                    <Image
                    ...
                    />
                    <div>
                      <p className="font-semibold text-gray-900" itemProp="name">{post.author.name}</p>
                      <time dateTime={post.publishedAt} className="text-gray-600" itemProp="datePublished">
                  ...
                  <div className="flex items-center space-x-4 text-gray-600">
                    <div className="flex items-center">
                      ...
                      <span itemProp="timeRequired" content={`PT${post.readTime}M`}>{post.readTime} min read</span>
                    </div>
                  </div>
                </div>
              </header>
